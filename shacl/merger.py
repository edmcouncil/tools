...
def merge(ontology_folder: str, ontology_file_path: str, catalog_file_path: str, merged_ontology_file_path: str):
    ...
    __close_imports(ontology=ontology, stored_ontologies=stored_ontologies, imported_ontologies=set())
    ontology.serialize(destination=merged_ontology_file_path, format='xml')
...
merge(
    ...
    merged_ontology_file_path='../resources/idmp/ISO/ISO11238-Substances-Merged.rdf')
