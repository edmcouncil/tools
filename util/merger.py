...
def __close_imports(ontology: Graph, imported_ontologies: set, stored_ontologies: dict) -> Graph:
    ...
    for importing_imported_ontology in importing_imported_ontologies:
        ...
        if imported_ontology_iri not in imported_ontologies:
            ...
            ontology += __close_imports(ontology=imported_ontology, imported_ontologies=imported_ontologies, stored_ontologies=stored_ontologies)
    return ontology
...
def merge(ontology_folder: str, ontology_file_path: str, catalog_file_path: str) -> Graph:
    ontology = Graph()
    ...
    merged_ontology = __close_imports(ontology=merged_ontology, stored_ontologies=stored_ontologies, imported_ontologies=set())
