...
def translate_custom_construct_to_self_standing_fol_formula(sw_triple: tuple, rdf_graph: Graph) -> Formula:
    triple_subject = get_fol_symbol_for_owl_node(identifier=sw_triple[0], rdf_graph=rdf_graph)
    triple_predicate = get_fol_symbol_for_owl_node(identifier=sw_triple[1], rdf_graph=rdf_graph, arity=2)
    triple_object = get_fol_symbol_for_owl_node(identifier=sw_triple[2], rdf_graph=rdf_graph)
