...
def translate_rdf_construct_to_fol_formula(rdf_predicate: URIRef, sw_arguments: list, variables: list, rdf_graph: Graph) -> Formula:
    match rdf_predicate:
...
def __translate_functionalProperty(sw_arguments: list, rdf_graph: Graph):
    ...
    property_formula_1 = get_subformula_from_node(node=sw_arguments[0], rdf_graph=rdf_graph,
