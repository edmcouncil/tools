...
check_spelling_in_ontology(new_spell_file_path='domain_specific_spellings.json', ontology_location='AboutIDMPDev-ReferenceIndividuals.ttl',resource_filter='idmp')
